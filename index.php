                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="color" class="form-control" id="color">
                                            ...
                                            <option style="color:#DC143C;" value="#DC143C">Vermelho</option>
                                            <option style="color:#C0C0C0;" value="#C0C0C0">Cinza</option>
                                            <option style="color:#A020F0;" value="#A020F0">Roxo</option>
                                            <option style="color:#8B4513;" value="#8B4513">Marrom</option>
                                            <option style="color:#FF6347;" value="#FF6347">Laranja</option>
                                            <option style="color:#00FFFF;" value="#00FFFF">Destaque Azul</option>
                                            <option style="color:#ADFF2F;" value="#ADFF2F">Destaque Verde</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
